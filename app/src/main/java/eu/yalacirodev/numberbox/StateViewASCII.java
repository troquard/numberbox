...
public class StateViewASCII extends androidx.appcompat.widget.AppCompatTextView implements StateView {
    ...
    public void showState (State state) {
        ...
        int textSize = 30 - (int) Math.round(Math.max(sizeX, sizeY) * 1.2);
